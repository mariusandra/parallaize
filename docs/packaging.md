...
```bash
sudo apt install ./artifacts/packages/parallaize_0.1.3-1_amd64.deb
...
curl -fLo /tmp/parallaize_0.1.3-1_amd64.deb \
  https://archive.parallaize.com/packages/parallaize_0.1.3-1_amd64.deb
sudo apt-get install -y /tmp/parallaize_0.1.3-1_amd64.deb
